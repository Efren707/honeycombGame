...
export default class Game {
    ...
    draw(c){
        ...
        if(this.currentLevel === 6 || this.currentLevel === 5){
            this.shot.play();
        } else {
            this.shot.stop();
        }
        ...
        if (this.currentLevel === 0){
            ...
            c.fill();
        } else if(this.currentLevel === 2){ // second level square
            c.lineWidth = 25;
            c.strokeStyle = "#b0881a";
            ...
            c.fillStyle = "blue";
            c.beginPath();
            c.arc(210, 220, 9, 0, Math.PI * 2, false);
            c.fill();
            ...
            c.fillStyle = "blue";
            c.beginPath();
            c.arc(311, 416, 8, 0, Math.PI * 2, false);
            c.fill();
            ...
            c.fillStyle = "blue";
            c.beginPath();
            c.arc(179, 222, 9, 0, Math.PI * 2, false);
            c.fill();
            ...
            c.fillStyle = "blue";
            c.beginPath();
            c.arc(289, 415, 9, 0, Math.PI * 2, false);
            c.fill();
        }
    }
    ...
    hitCheck(x, y){
        ...
        if(this.currentLevel === 1 && x > 290 && x < 307 && y > 148 && y < 453 ){
            this.health = 0;
        }
        ...
        if(this.currentLevel === 2 && x === 187 && y > 210 && y < 230){
            this.health = 0;
        }

        if (this.currentLevel === 2 && x < 225 && x > 220 && y < 224 && y > 219 && this.health > 0) {
            this.currentLevel = 8;
        }
        ...
        if (this.currentLevel === 3 && x > 292 && x < 300 && y < 195 && y > 165) {
            this.health = 0;
        }
        ...
        if (this.currentLevel === 4 && x < 318 && x > 310 && y < 430 && y > 410 && this.health > 0) {
            this.currentLevel++;
        }
        ...
        // Level 2 loading screen
        if (this.currentLevel === 7 && (y < 230 && y > 211 ) && (x < 185 && x > 178)){
            this.currentLevel = 2;
        }
        ...
        // Level 4 loading screen
        if (this.currentLevel === 9 && y < 425 && y > 413 && x < 300 && x > 275) {
            this.currentLevel = 4;
        }
    }
